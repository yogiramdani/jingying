    ...
    <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body p-lg-17">
                    ...
                    <div class="row mb-3">
                        <!--begin::Col-->
                        <div class="col-md-8 pe-lg-10">
                            <!--begin::Form-->
                            <form action="" class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="kt_contact_form">
                                <h1 class="fw-bolder text-dark mb-9">{{ __('messages.title') }}</h1>
                                <p>{{ __('messages.email') }} : info@jingyinghunterjob.com</p>
                                <p>{{ __('messages.alamat') }} : {{ __('messages.lokasi') }}</p>
                                <!--begin::Input group-->
                                <div class="row mb-5">
                                    <div class="col-md-6">
                                        <img src="wechat.png" style="width:300px">
                                    </div>
                                    <div class="col-md-6">
                                        <img src="wa.png" style="width:300px">
                                    </div>
                                </div>
                                <!--end::Input group-->
